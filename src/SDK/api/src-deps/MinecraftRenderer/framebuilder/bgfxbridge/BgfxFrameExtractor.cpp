...
namespace mce::framebuilder::bgfxbridge {
    ...
    void BgfxFrameExtractor::_insert(
        ...
        (this->*Bind::origin)(entityContext, description);
    }
    ...
    void BgfxFrameExtractor::_insert(const EntityCreationContext &entityContext, const BlitFlipbookTextureDescription &descriptions) {
        ...
        using Bind = sapphire::bind::Fn<
            ...
            (Fn)&BgfxFrameExtractor::_insert>;
        (this->*Bind::origin)(entityContext, descriptions);
    }
    ...
    void BgfxFrameExtractor::_insert(const EntityCreationContext &entityContext, const RenderMeshFallbackDescription &descriptions) {
        ...
        using Bind = sapphire::bind::Fn<
            "\x48\x89\x5C\x24\x20\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\xFF\xFF\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x00\x8B\x00\x48\x89\x54\x24\x00\x48\x89\x4C\x24\x48"_sig,
            (Fn)&BgfxFrameExtractor::_insert>;
        (this->*Bind::origin)(entityContext, descriptions);
    }

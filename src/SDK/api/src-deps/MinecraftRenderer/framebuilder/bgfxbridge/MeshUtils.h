...
namespace mce::framebuilder::bgfxbridge {
    ...
    namespace meshutils {
        ...
        SPHR_DECL_API("1.21.2,1.21.50,1.21.60", "\xE8\x00\x00\x00\x00\x4C\x8B\xD8\x48\x8B\x8D")
    ...
    SPHR_DECL_API("1.21.2", "\xE8\x00\x00\x00\x00\x90\x41\xB2")
    SPHR_DECL_API("1.21.50", "\xE8\x00\x00\x00\x00\x90\xB3\x00\x66\xC7\x44\x24")
    SPHR_DECL_API("1.21.60", "\xE8\x00\x00\x00\x00\x90\x48\x8D\x8D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x8B\x4B")

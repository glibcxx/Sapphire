...
public:
    ...
    SPHR_DECL_API("1.21.2", "move", "\x48\x8B\x15\x00\x00\x00\x00\x48\x3B\x15\x00\x00\x00\x00\x74\x00\x48\x89\x1A\x48\x83\x05\x00\x00\x00\x00\x00\xEB\x00\x48\x8D\x0D\x00\x00\x00\x00\xEB")
    SPHR_DECL_API("1.21.50,1.21.60", "move", "\x48\x8B\x0D\x00\x00\x00\x00\x49\x8B\xD6")
    SDK_API static std::vector<TerrainLayer *> sAllLayers;
    SPHR_DECL_API("1.21.2,1.21.50,1.21.60", "move,disp:-8", "\x48\x8B\x05\x00\x00\x00\x00\x48\x2B\xC3\x48\xC1\xF8\x00\x48\x8D\x3C\xC3")

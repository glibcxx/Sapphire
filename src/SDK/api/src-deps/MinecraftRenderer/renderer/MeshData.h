...
namespace mce {
    ...
    public:
        ...
        SAPPHIRE_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x41\xBD\x00\x00\x00\x00\x48\x8B\x8D")
        SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x4C\x8B\x8E\x00\x00\x00\x00\x45\x89")
        SDK_API void dtor();

        SAPPHIRE_API("1.21.50,1.21.60", "call", "\x48\x89\x5C\x24\x00\x48\x89\x54\x24\x00\x57\x48\x83\xEC\x00\x48\x8B\xFA\x48\x8B\xD9\x0F\xB6\x01")
        SDK_API MeshData clone() const;

        SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "\x48\x83\xEC\x00\xC6\x01\x00\x48\x8B\x41")
        SDK_API void clear();
    };

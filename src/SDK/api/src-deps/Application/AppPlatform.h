...
public:
    ...
    SPHR_DECL_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x48\x89\x7C\x24\x00\x55\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x45\x00\x48\x8B\xF1\x45\x33\xF6")
    SPHR_DECL_API("1.21.50", "")
    SPHR_DECL_API("1.21.60", "")
    SDK_API /*virtual*/ void initialize();

    SPHR_DECL_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x57\x48\x83\xEC\x00\x0F\x29\x74\x24\x00\x0F\x28\xF2")
    SPHR_DECL_API("1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x48\x89\x6C\x24\x00\x56\x57\x41\x56\x48\x83\xEC\x00\x0F\x29\x74\x24\x00\x0F\x28\xF2\x48\x8B\xEA\x48\x8B\xF1")
    SDK_API /*virtual*/ void addListener(Listener *l, float priority);

    SPHR_DECL_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x57\x48\x83\xEC\x00\x48\x8B\xF9\x48\x8B\xF2\x48\x81\xC1\x00\x00\x00\x00\xFF\x15\x00\x00\x00\x00\x85\xC0\x74\x00\x8B\xC8\xFF\x15\x00\x00\x00\x00\xCC\x48\x8B\x47")
    SPHR_DECL_API("1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x57\x48\x83\xEC\x00\x48\x8B\xF2\x48\x8B\xF9\x48\x81\xC1\x00\x00\x00\x00\xFF\x15\x00\x00\x00\x00\x85\xC0")
    SDK_API /*virtual*/ void removeListener(Listener *l);

    SPHR_DECL_API("1.21.2,1.21.50,1.21.60", "call", "\xE9\x00\x00\x00\x00\xFF\x15\x00\x00\x00\x00\xCC\xCC\xCC\xCC\xC6\x41")
...
template <>
SPHR_DECL_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x90\x48\x8B\x8B\x00\x00\x00\x00\x48\x8B\x01\x48\x8B\x40")
SPHR_DECL_API("1.21.50", "call", "\xE8\x00\x00\x00\x00\x90\xC6\x45\x00\x00\x48\x8B\x8D\x00\x00\x00\x00\x48\x85\xC9\x74\x00\xF0\xFF\x41")
SPHR_DECL_API("1.21.60", "call", "\xE8\x00\x00\x00\x00\x90\x48\x8B\x8D\x00\x00\x00\x00\x48\x8B\x01\x48\x8B\x40\x00\xFF\x15\x00\x00\x00\x00\x48\x8B\xBC\x24")

...
namespace Bedrock {
    ...
    public:
        ...
        SDK_API ActivationArguments();

        SPHR_DECL_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x4C\x24\x00\x57\x48\x83\xEC\x00\x48\x8B\xD9\xC7\x44\x24\x00\x00\x00\x00\x00\x48\x8D\x54\x24")
        SPHR_DECL_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x90\x4C\x89\xB7\x00\x00\x00\x00\x48\x89\x3D")
        SPHR_CTOR_ALIAS SDK_API ActivationArguments *ctor();

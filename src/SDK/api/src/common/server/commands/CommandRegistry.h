...
public:
    ...
    SPHR_DECL_API("1.21.2", "disp:6,call", "\x49\x8B\xD5\x48\x8B\xCF\xE8\x00\x00\x00\x00\x48\x89\x45")
    ...
    SPHR_DECL_API("1.21.2", "disp:36,call", "\x88\x44\x24\x00\x88\x54\x24\x00\x66\x89\x54\x24")

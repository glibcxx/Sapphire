...
public:
    ...
    SAPPHIRE_API("1.21.2", "\x40\x53\x48\x83\xEC\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x44\x24\x00\x8B\x41\x00\x48\x8D\x54\x24")
    SAPPHIRE_API("1.21.50,1.21.60", "\x40\x53\x48\x83\xEC\x00\x4C\x8B\x51\x00\xBB\x00\x00\x00\x00\x8B\x51")

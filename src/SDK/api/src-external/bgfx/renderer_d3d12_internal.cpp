...
void bgfx::d3d12::CommandContextD3D12::setBlendState(
    ...
    (this->*Bind::origin)(_desc, _state, _rgba);
}
...
uint32_t bgfx::d3d12::CommandContextD3D12::setInputLayout(
    ...
    return (this->*Bind::origin)(_vertexElements, _numStreams, _vertexDecls, _program, _numInstanceData);
}
...
ID3D12PipelineState *bgfx::d3d12::CommandContextD3D12::getPipelineState(
    ...
    return (this->*Bind::origin)(_context, _state, _stencil, _biasConst, _biasSlope, _biasClamp, _numStreams, _vertexDecls, _programIdx, _numInstanceData, _fbh, _sampleDesc);
}

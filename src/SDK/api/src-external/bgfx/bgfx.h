...
namespace bgfx {
    ...
    SAPPHIRE_API("1.21.50", "mov", "\x48\x8B\x15\x00\x00\x00\x00\x45\x33\xDB")
    extern SDK_API bgfx::Context *s_ctx;
    SAPPHIRE_API("1.21.50", "mov", "\x48\x8B\x0D\x00\x00\x00\x00\x81\xC7")
    ...
    struct VertexDecl {
        ...
        SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x55\x48\x8B\xEC\x48\x83\xEC\x00\x45\x33\xC9") // 1.21.50
        SDK_API void end();
    };
    ...
    // size: 1
    struct Encoder {
        SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x7C\x24\x00\x4C\x8B\x11\x0F\xB7\xFA") // 1.21.50
        SDK_API uint16_t setScissor(uint16_t _x, uint16_t _y, uint16_t _width, uint16_t _height);

        SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x48\x89\x7C\x24\x00\x41\x0F\xB7\xC0") // 1.21.50
    ...
    SAPPHIRE_API("1.21.50", "\x40\x53\x56\x57\x48\x83\xEC\x00\x0F\xB6\xF2") // 1.21.50
    SDK_API int init(const Init &_init, bool a2);

    SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x55\x56\x57\x48\x83\xEC\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x44\x24\x00\x48\x8B\xFA\x48\x8B\xD9\x48\x83\x3D") // 1.21.50
    ...
    SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x6C\x24\x00\x56\x57\x41\x56\x48\x83\xEC\x00\x41\x0F\xB7\xF8") // 1.21.50
    ...
    SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x56\x41\x57\x48\x83\xEC\x00\x0F\xB7\xFA") // 1.21.50
    SDK_API bgfx::DynamicIndexBufferHandle createDynamicIndexBuffer(const bgfx::Memory *_mem, uint16_t _flags = 0x0000);

    SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x6C\x24\x00\x56\x57\x41\x56\x48\x83\xEC\x00\x48\x8B\x35\x00\x00\x00\x00\x4C\x8B\xF1") // 1.21.50
    SDK_API void allocInstanceDataBuffer(InstanceDataBuffer *_idb, uint32_t _num, uint16_t _stride);

    SAPPHIRE_API("1.21.50", "\x40\x53\x55\x56\x57\x41\x56\x41\x57\x48\x83\xEC\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x44\x24\x00\x48\x8B\x2D") // 1.21.50

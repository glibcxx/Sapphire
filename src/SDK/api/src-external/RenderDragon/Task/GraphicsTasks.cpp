...
namespace dragon::task {
    ...
    GraphicsTasks *GraphicsTasks::ctor(
        ...
        using Bind = sapphire::bind::Fn<
            ...
            &GraphicsTasks::ctor>;
        return (this->*Bind::origin)(rendererPool, std::move(helperPools), clientScheduler);
    }
    ...
    GraphicsTasks::InitializationState GraphicsTasks::continueInit(InitializationState initState) {
        ...
        return (this->*Bind::origin)(std::move(initState));
    }
...
#endif
            &GraphicsTasks::frame>;
        return (this->*Bind::origin)(frameContentCallback, a2);
    }

...
#pragma SPHR_LINKER_SYM_ALIAS(                                                                                \
    ...
    "?ctor@MaterialUniformMap@materials@dragon@@QEAAPEAU123@AEBU123@AEAV?$CheckedRingBuffer@$01$0A@@Core@@@Z" \
        ...
        SAPPHIRE_API("1.21.2", "\x40\x53\x55\x56\x57\x41\x56\x48\x83\xEC\x00\x48\x8B\xF2\x48\x8B\xD9")
        SAPPHIRE_API("1.21.50,1.21.60", "\x40\x53\x55\x56\x57\x41\x54\x41\x56\x41\x57\x48\x83\xEC\x00\x4C\x8B\xF2\x48\x8B\xF9\x45\x33\xE4")
        SDK_API MaterialUniformMap *ctor(const MaterialUniformMap &other, Core::CheckedRingBuffer<2, 0> &allocator);

        SAPPHIRE_API("1.21.2", "call", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x49\x8B\xD8\x4C\x8B\xE2\x48\x89\x55")
        SAPPHIRE_API("1.21.50,1.21.60", "call", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x49\x8B\xD8\x4C\x8B\xE2\x48\x89\x54\x24")

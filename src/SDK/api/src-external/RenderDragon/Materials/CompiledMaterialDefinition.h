...
namespace dragon::materials {
    ...
    public:
        ...
        struct Variant {
            ...
            SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x48\x81\xC3\x00\x00\x00\x00\x48\x3B\xDF\x75\x00\x4D\x89\x67\x00\x48\x8B\x4C\x24")
        ...
        struct Pass {
            ...
            SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x41\xFF\xC5\x44\x89\x6C\x24\x00\x0F\xB7\x45")
            SDK_API void dtor() noexcept;
        };
        ...
        public:
            ...
            SAPPHIRE_API("1.21.50", "call", "\xE8\x00\x00\x00\x00\x49\x89\x87\x00\x00\x00\x00\x48\x8B\x4E") // 1.21.50
        ...
        SAPPHIRE_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x4C\x24\x00\x55\x56\x57\x48\x83\xEC\x00\x48\x8B\xF1\xE8")
        SAPPHIRE_API("1.21.50,1.21.60", "")
        SDK_API CompiledMaterialDefinition *ctor();

        SAPPHIRE_API("1.21.50", "call", "\xE8\x00\x00\x00\x00\x0F\xB6\xD8\xEB\x00\x48\x0F\xBE\x46")

...
void dragon::rendering::drawcommands::applyState(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        &applyState>;
    return (Bind::origin)(commands, scissorRect, state);
}
...
bool dragon::rendering::drawcommands::bindMesh(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        &bindMesh>;
    return (Bind::origin)(commands, meshFilter);
}
...
bool dragon::rendering::drawcommands::extractUniforms(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        &extractUniforms>;
    return (Bind::origin)(commands, pipeline, materialFilter, uniformOverrides);
}
...
bool dragon::rendering::drawcommands::submit(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        (Fn)&submit>;
    return (Bind::origin)(commands, preserveState, id, transform, pass, depth);
}
...
bool dragon::rendering::drawcommands::submit(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        (Fn)&submit>;
    return (Bind::origin)(commands, preserveState, id, transform, program, depth);
}
...
bool dragon::rendering::drawcommands::submitInstanced(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        (Fn)&submitInstanced>;
    return (Bind::origin)(commands, preserveState, id, instanceCount, program, depth);
}
...
bool dragon::rendering::drawcommands::submitInstanced(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        (Fn)&submitInstanced>;
    return (Bind::origin)(commands, preserveState, id, transforms, pass, depth);
}
...
bool dragon::rendering::drawcommands::submitInstanced(
    ...
    using Bind = sapphire::bind::Fn<
        ...
        (Fn)&submitInstanced>;
    return (Bind::origin)(commands, preserveState, id, transforms, program, fallbackProgram, depth);
}
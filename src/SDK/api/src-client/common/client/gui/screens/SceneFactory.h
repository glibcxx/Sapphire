...
public:
    ...
    SPHR_DECL_API("1.21.2", "\x40\x55\x53\x56\x57\x41\x54\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x49\x8B\xF8\x48\x8B\xF1")
    SPHR_DECL_API("1.21.50", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x49\x8B\xF8\x48\x8B\xDA\x48\x8B\xF1\x48\x89\x4D")
    SPHR_DECL_API("1.21.60", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x4D\x8B\xF0\x48\x8B\xFA\x48\x8B\xF1\x48\x89\x4D")
    SPHR_CTOR_ALIAS SDK_API SceneFactory *ctor(
        IMinecraftGame                                              &minecraft,
        const Bedrock::NotNullNonOwnerPtr<IClientInstance>          &client,
        const Bedrock::NotNullNonOwnerPtr<IAdvancedGraphicsOptions> &graphicsOptions,
        OreUI::SceneProvider                                        &sceneProvider

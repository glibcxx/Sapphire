...
#pragma SPHR_LINKER_SYM_ALIAS("??0ModelPart@@QEAA@HHHH@Z", "?ctor@ModelPart@@QEAAPEAV1@HHHH@Z")
    ...
    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x90\x4C\x8D\x00\x00\x00\x00\x00\xC7\x44\x24\x20\x20\x00\x00\x00\x41\xB9\x40\x00\x00\x00\x45\x33\xC0\x33\xD2\x49\x8B")
...
#pragma SPHR_LINKER_SYM_ALIAS("??1ModelPart@@QEAA@XZ", "?dtor@ModelPart@@QEAAXXZ")
    ...
    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\xF3\x0F\x11\x7C\x24\x00\xC7\x44\x24")

...
#pragma SPHR_LINKER_SYM_ALIAS("??0MinecraftGame@@QEAA@XZ", "?ctor@MinecraftGame@@QEAAPEAV1@XZ")
    ...
    SAPPHIRE_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x4C\x24\x00\x55\x56\x57\x48\x83\xEC\x00\x48\x8B\xF9\x33\xF6")
    SAPPHIRE_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x6C\x24\x00\x56\x57\x41\x54\x41\x56\x41\x57\x48\x83\xEC\x00\x48\x8B\xF9\x48\x89\x4C\x24\x00\x33\xED")
    SAPPHIRE_API("1.21.60", "\x48\x89\x5C\x24\x00\x48\x89\x6C\x24\x00\x48\x89\x74\x24\x00\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x83\xEC\x00\x48\x8B\xF9\x48\x89\x4C\x24\x00\x33\xED")
    ...
    // vtb+1
    SAPPHIRE_API("1.21.2,v1_21_50", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x55\x57\x41\x54\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x85\x00\x00\x00\x00\x4C\x8B\xF1\x45\x33\xE4\x48\x8D\x91")
    SAPPHIRE_API("v1_21_60", "")
    SDK_API virtual void initialize(int argc, char **argv) override;

    // vtb+2
    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "\x40\x53\x48\x83\xEC\x00\x48\x8B\xD9\xE8\x00\x00\x00\x00\x48\x8B\x8B\x00\x00\x00\x00\xBA")
    SDK_API virtual void update() override;

    // vtb+1 (for IGameServerShutdown)
    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x55\x56\x57\x48\x83\xEC\x00\x48\x8B\x41\x00\x48\x8B\xF9")
    SDK_API virtual void requestLeaveGame(bool switchScreen, bool sync) override;

    SAPPHIRE_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x80\xBE\x00\x00\x00\x00\x00\x74\x00\x48\x8B\x9E")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x41\x80\xBF\x00\x00\x00\x00\x00\x74\x00\x49\x8B\x9F")
    SDK_API void startFrame();

    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "disp:2,call", "\x8B\x00\xE8\x00\x00\x00\x00\x00\x8B\x00\x00\x00\x00\x00\xC6\x80\xB8\x00\x00\x00\x00\x00\x8B")
    SDK_API void endFrame();

    SAPPHIRE_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x90\x48\x8D\x8D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x48\x8B\x46\x00\x48\x8D\x95")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x90\x48\x8D\x8D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x49\x8D\x4F\x00\x49\x8B\x47\x00\x48\x8D\x95\x00\x00\x00\x00\x48\x8B\x40\x00\xFF\x15\x00\x00\x00\x00\x90\x4D\x8B\xC4")
    SDK_API void updateGraphics(IClientInstance &client, const Timer &timer);

    SAPPHIRE_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x90\x48\x8D\x8D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x0F\xB6\x44\x24\x00\x88\x86")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x90\x48\x8D\x8D\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x0F\xB6\x44\x24\x00\x41\x88\x87")
    SDK_API void updateAudio(IClientInstance &client, const Timer &timer);

    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x48\x8B\x8B\x00\x00\x00\x00\xBA\x00\x00\x00\x00\x48\x83\xC4")
    SDK_API void _update();

    SAPPHIRE_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x44\x0F\xB6\xF0\x88\x44\x24\x00\x80\xBE")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x0F\xB6\xF8\x88\x44\x24\x00\x41\x80\xBF")
    SDK_API bool _clientUpdate();

    SAPPHIRE_API("1.21.2", "disp:3,call", "\x48\x8B\xCE\xE8\x00\x00\x00\x00\x48\x8B\x8E\x00\x00\x00\x00\xE8\x00\x00\x00\x00\x49\x8B\x16")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x49\x8B\xBE\x00\x00\x00\x00\x48\x8B\x07\x48\x85\xC0")
    SDK_API void _InitComplete();

    SAPPHIRE_API("1.21.2", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x56\x41\x57\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x4C\x8B\xF2\x48\x8B\xF1\x45\x33\xFF")
    SAPPHIRE_API("1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x54\x41\x55\x41\x56\x41\x57\x48\x8D\xAC\x24\x00\x00\x00\x00\x48\x81\xEC\x00\x00\x00\x00\x4C\x8B\xE2\x4C\x8B\xF1\x45\x33\xED")

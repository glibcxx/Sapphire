...
public:
    ...
    SPHR_CTOR_ALIAS SDK_API ClientInstance *ctor(
        IMinecraftGame                                             &mg,
        IMinecraftApp                                              &app,
        LevelListener                                              &levelListener,
        SubClientId                                                 subid,
...
#if MC_VERSION == v1_21_50 || MC_VERSION == v1_21_60
        return sapphire::vCall<bool>(this, 167);
#elif MC_VERSION == v1_21_2
        return sapphire::vCall<bool>(this, 162);
#endif
    }

    /*virtual*/ bool isShowingMenu() const /*override*/ {
#if MC_VERSION == v1_21_50 || MC_VERSION == v1_21_60
        return sapphire::vCall<bool>(this, 172); // \x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x48\x89\x7C\x24\x00\x55\x41\x56\x41\x57\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x45\x00\x48\x8B\xD9\x45\x33\xFF\x44\x89\x7C\x24\x00\x44\x88\x7D
#elif MC_VERSION == v1_21_2
        return sapphire::vCall<bool>(this, 167); // \x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x48\x89\x7C\x24\x00\x55\x41\x56\x41\x57\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x45\x00\x48\x8B\xD9\x33\xFF\x89\x7C\x24\x00\x40\x88\x7D
#endif
    }

    /*virtual*/ void grabMouse() const /*override*/ {
#if MC_VERSION == v1_21_50 || MC_VERSION == v1_21_60
        sapphire::vCall(this, 340);
#elif MC_VERSION == v1_21_2
        sapphire::vCall(this, 332);
#endif
    }
...
#if MC_VERSION == v1_21_50 || MC_VERSION == v1_21_60
        sapphire::vCall(this, 341);
#elif MC_VERSION == v1_21_2
        sapphire::vCall(this, 333);
#endif
    }

...
#pragma SPHR_LINKER_SYM_ALIAS(                                                                                                                   \
    ...
    SAPPHIRE_API("1.21.2,1.21.50", "\x48\x8B\xC4\x48\x89\x58\x00\x48\x89\x50\x00\x48\x89\x48\x00\x55\x56\x57\x41\x56")
    SAPPHIRE_API("1.21.60", "\x48\x89\x54\x24\x00\x48\x89\x4C\x24\x00\x53\x55\x56\x57\x41\x56\x48\x83\xEC\x00\x49\x8B\xD9\x49\x8B\xE8")

...
#endif
        &ActorShaderManager::getTransparentEntityMaterial>;
    return (this->*Bind::origin)();
}
...
void ActorShaderManager::setupShaderParameters(
    ...
    Bind::origin(screenContext, entityContext, entity, overlay, changeColor, changeColor2, glintColor, uvOffset1, uvOffset2, uvRot1, uvRot2, glintUVScale, uvAnim, br, lightEmission);
}
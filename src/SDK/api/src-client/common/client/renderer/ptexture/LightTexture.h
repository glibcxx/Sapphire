...
#pragma SPHR_LINKER_SYM_ALIAS("??0LightTexture@@QEAA@AEAVMinecraftGameplayGraphicsResources@@E@Z", "?ctor@LightTexture@@QEAAPEAV1@AEAVMinecraftGameplayGraphicsResources@@E@Z")
    ...
    SAPPHIRE_API("1.21.2", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x56\x41\x57\x48\x83\xEC\x00\x4C\x8B\xF2\x48\x8B\xF9\x48\x89\x4C\x24\x00\x45\x33\xFF")
    SAPPHIRE_API("1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x55\x56\x57\x41\x56\x41\x57\x48\x83\xEC\x00\x48\x8B\xEA\x48\x8B\x00\x48\x89\x4C\x24\x00\x45\x33\xFF\x4C\x89\x39")

...
#pragma SDK_LINKER_SYM_ALIAS("??0LightTexture@@QEAA@AEAVMinecraftGameplayGraphicsResources@@E@Z", "?ctor@LightTexture@@QEAAPEAV1@AEAVMinecraftGameplayGraphicsResources@@E@Z")

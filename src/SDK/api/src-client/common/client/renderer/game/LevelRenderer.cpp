...
#endif
        &LevelRenderer::ctor>;
    return (this->*Hook::origin)(clientInstance, level, options, textures, terrainTexture, std::move(localPlayer), holographicPlatform, gameRenderer, soundPlayer, geometryGroup, sounds, entityResourceDefGroup);
}

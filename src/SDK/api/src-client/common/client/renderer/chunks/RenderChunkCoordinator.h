...
#pragma SPHR_LINKER_SYM_ALIAS(                                                                               \
    ...
    SAPPHIRE_API("1.21.50", "call", "\xE8\x00\x00\x00\x00\xEB\x00\x49\x8B\xF6\x0F\x57\xC0\x0F\x11\x44\x24")
    ...
    SAPPHIRE_API("1.21.50", "call", "\xE8\x00\x00\x00\x00\x48\x8B\x03\x48\x8B\xD8\x48\x3B\xC6\x75\x00\x48\x8B\x8F")
    SDK_API void tick();

    SAPPHIRE_API("1.21.50", "\x40\x53\x55\x56\x57\x41\x55\x41\x56\x41\x57\x48\x83\xEC\x00\x4D\x8B\xF8")
    SDK_API std::shared_ptr<RenderChunkShared> getOrCreateChunkAtPos(const SubChunkPos &pos);

    SAPPHIRE_API("1.21.50", "call", "\xE8\x00\x00\x00\x00\x48\x8B\x03\x48\x8B\xD8\x48\x3B\xC7\x75\x00\x4D\x8B\xC5")

...
public:
    ...
    SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x57\x48\x83\xEC\x00\x48\x89\x51\x00\x48\x8B\xD9")
    SDK_API void reset(BlockSource *region, const BlockPos &startPostion);

    SAPPHIRE_API("1.21.2", "call", "\xE8\x00\x00\x00\x00\x41\xBC\x00\x00\x00\x00\x33\xF6")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\x45\x33\x00\x4C\x8D\x5C\x24")

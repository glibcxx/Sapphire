...
#pragma SDK_LINKER_SYM_ALIAS("??0BlockTessellator@@QEAA@PEAVBlockSource@@@Z", "?ctor@BlockTessellator@@QEAAPEAV1@PEAVBlockSource@@@Z")
...
#pragma SDK_LINKER_SYM_ALIAS("??1BlockTessellator@@QEAA@XZ", "?dtor@BlockTessellator@@QEAAXXZ")

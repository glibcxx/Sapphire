...
public:
    ...
    SPHR_CTOR_ALIAS SDK_API BlockTessellator *ctor(BlockSource *level);
    ...
    SPHR_DECL_API("1.21.50", "\x48\x89\x5C\x24\x00\x48\x89\x6C\x24\x00\x56\x57\x41\x56\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\xEA\x48\x8B\xF1\x48\x8B\x49")
    SDK_API void _updateChunk3DBiome(const BlockPos &chunkCenter);

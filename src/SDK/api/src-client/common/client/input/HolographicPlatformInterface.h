...
#pragma SPHR_LINKER_SYM_ALIAS("??0HoloFrameOfReferenceSetupData@HolographicPlatform@@QEAA@XZ", "?ctor@HoloFrameOfReferenceSetupData@HolographicPlatform@@QEAAPEAU12@XZ")
        ...
        SAPPHIRE_API("1.21.2,1.21.50,1.21.60", "\x33\xC0\x48\xC7\x41\x00\x00\x00\x00\x00\x48\x89\x01\x48\x89\x41\x00\x89\x41")
...
#pragma SPHR_LINKER_SYM_ALIAS("??0HolographicPlatform@@QEAA@XZ", "?ctor@HolographicPlatform@@QEAAPEAV1@XZ")
    ...
    SAPPHIRE_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x4C\x24\x00\x57\x48\x83\xEC\x00\x48\x8B\xD9\x48\x8D\x05\x00\x00\x00\x00\x48\x89\x01\x48\x83\xC1\x00\xE8")
    SAPPHIRE_API("1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x48\x89\x74\x24\x00\x48\x89\x4C\x24\x00\x57\x48\x83\xEC\x00\x48\x8B\xF9\x48\x8D\x05\x00\x00\x00\x00\x48\x89\x01\x48\x83\xC1\x00\xE8")
    SDK_API HolographicPlatform *ctor();

    // vtb+0
    virtual ~HolographicPlatform();

    SAPPHIRE_API("1.21.2", "\x40\x55\x56\x57\x41\x54\x41\x56\x41\x57\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x44\x24\x00\x80\xB9\x00\x00\x00\x00\x00\x45\x8B\xE1")
    SAPPHIRE_API("1.21.50,1.21.60", "call", "\xE8\x00\x00\x00\x00\xF3\x44\x0F\x10\x65\x00\x0F\x28\xD6")
    SDK_API Matrix _getTransform(TransformSpace spaceA, TransformSpace spaceB);

    SAPPHIRE_API("1.21.2", "\x48\x89\x5C\x24\x00\x48\x89\x7C\x24\x00\x55\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x45\x00\x48\x8B\xF9\x83\xFA")
    SAPPHIRE_API("1.21.50,1.21.60", "\x48\x89\x5C\x24\x00\x55\x48\x8D\x6C\x24\x00\x48\x81\xEC\x00\x00\x00\x00\x48\x8B\x05\x00\x00\x00\x00\x48\x33\xC4\x48\x89\x45\x00\x48\x8B\xD9\x83\xFA")

...
public:
    ...
    SDK_API AppPlatformWinRTDispatcher(winrt::Windows::UI::Core::CoreWindow coreWindow);
    ...
    SPHR_CTOR_ALIAS AppPlatformWinRTDispatcher *ctor(winrt::Windows::UI::Core::CoreWindow coreWindow);
};
